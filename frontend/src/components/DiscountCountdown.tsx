    ...
    <div className="flex flex-col items-center">
      <div
        ...
        style={{
          ...
          boxShadow: '0 0 14px oklch(0.78 0.12 75 / 0.12), inset 0 0 10px oklch(0.78 0.12 75 / 0.04)',
        }}
      >
        {value}
        <span
          className="absolute top-0 left-0 w-2 h-2"
          style={{ borderTop: '1px solid oklch(0.78 0.12 75 / 0.7)', borderLeft: '1px solid oklch(0.78 0.12 75 / 0.7)' }}
        />
        <span
          className="absolute top-0 right-0 w-2 h-2"
          style={{ borderTop: '1px solid oklch(0.78 0.12 75 / 0.7)', borderRight: '1px solid oklch(0.78 0.12 75 / 0.7)' }}
        />
        <span
          className="absolute bottom-0 left-0 w-2 h-2"
          style={{ borderBottom: '1px solid oklch(0.78 0.12 75 / 0.7)', borderLeft: '1px solid oklch(0.78 0.12 75 / 0.7)' }}
        />
        <span
          className="absolute bottom-0 right-0 w-2 h-2"
          style={{ borderBottom: '1px solid oklch(0.78 0.12 75 / 0.7)', borderRight: '1px solid oklch(0.78 0.12 75 / 0.7)' }}
        />
      </div>
      <span
...
function ActiveOffer({ badge, title, subtitle, deadline, timeLeft }: ActiveOfferProps) {
  ...
  return (
    ...
    >
      {/* Corner accents */}
      <span className="absolute top-0 left-0 w-4 h-4" style={{ borderTop: `1px solid ${gold.replace(')', ' / 0.6)')}`, borderLeft: `1px solid ${gold.replace(')', ' / 0.6)')}` }} />
      <span className="absolute top-0 right-0 w-4 h-4" style={{ borderTop: `1px solid ${gold.replace(')', ' / 0.6)')}`, borderRight: `1px solid ${gold.replace(')', ' / 0.6)')}` }} />
      <span className="absolute bottom-0 left-0 w-4 h-4" style={{ borderBottom: `1px solid ${gold.replace(')', ' / 0.6)')}`, borderLeft: `1px solid ${gold.replace(')', ' / 0.6)')}` }} />
      <span className="absolute bottom-0 right-0 w-4 h-4" style={{ borderBottom: `1px solid ${gold.replace(')', ' / 0.6)')}`, borderRight: `1px solid ${gold.replace(')', ' / 0.6)')}` }} />

      {/* Subtle radial glow */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: 'radial-gradient(ellipse 80% 60% at 50% 50%, oklch(0.78 0.12 75 / 0.05) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative flex items-center gap-2 w-full max-w-[240px]">
        ...
        <div className="w-1 h-1 rotate-45" style={{ background: 'oklch(0.78 0.12 75 / 0.55)' }} />
        <div className="flex-1 h-px" style={{ background: 'oklch(0.78 0.12 75 / 0.2)' }} />
      </div>
      ...
      >
        <div className="relative max-w-5xl mx-auto flex flex-col items-center gap-4">
          <div className="flex items-center gap-3">
            <Sparkles size={14} strokeWidth={1.5} style={{ color: 'oklch(0.78 0.12 75 / 0.7)' }} />
            <span
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: 'radial-gradient(ellipse 80% 50% at 50% 50%, oklch(0.78 0.12 75 / 0.03) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative max-w-5xl mx-auto flex flex-col items-center gap-6">
        ...
        <ActiveOffer
          ...
          title={isHoli ? 'Holi Festival Discount' : 'Launch Introductory Discount'}
          subtitle={
            isHoli
