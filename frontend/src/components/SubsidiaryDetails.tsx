...
export default function SubsidiaryDetails({ subsidiary, onClose }: Props) {
  ...
  useEffect(() => {
    const handleKey = (e: KeyboardEvent) => {
      ...
      if (e.key === 'ArrowRight') setCurrentImage((i) => (i + 1) % subsidiary.images.length);
      if (e.key === 'ArrowLeft') setCurrentImage((i) => (i - 1 + subsidiary.images.length) % subsidiary.images.length);
    };
      ...
      >
        ...
        <button
          ...
          onMouseLeave={(e) => {
            ...
            (e.currentTarget as HTMLButtonElement).style.borderColor = 'oklch(0.78 0.12 75 / 0.3)';
          }}
        >
          ✕
        </button>
        ...
        <div className="relative w-full h-64 md:h-80 overflow-hidden">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(to bottom, transparent 60%, oklch(0.10 0.01 60))',
            }}
          />
          ...
          {subsidiary.images.length > 1 && (
            <>
              <button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  setCurrentImage((i) => (i - 1 + subsidiary.images.length) % subsidiary.images.length);
                }}
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            <img src={subsidiary.icon} alt="" className="w-8 h-8 object-contain" />
            <span
