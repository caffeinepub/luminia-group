          ...
          {!showQR ? (
            ...
            >
              ...
              <div>
                ...
                >
                  We accept payments via Google Pay and all UPI apps. Click the
                  button below to view the payment QR code.
                </p>
              </div>
            ...
            >
              ...
              <p
                ...
                style={{ color: "oklch(0.78 0.12 75 / 0.4)" }}
              >
                Tapping "Payment Done" instantly opens WhatsApp with your
                auto-generated UTE reference number.
              </p>
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.color =
                    "oklch(0.78 0.12 75 / 0.65)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.color =
                    "oklch(0.78 0.12 75 / 0.35)";
                }}
              >
                ← Go back
              </button>
