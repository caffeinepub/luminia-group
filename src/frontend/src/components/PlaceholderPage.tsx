  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, oklch(0.72 0.14 85 / 0.5), transparent)",
        }}
      />
      ...
      >
        ...
        <p className="text-ivory-faint text-sm md:text-base font-light leading-relaxed tracking-wide max-w-md">
          We are currently refining our digital presence. Our website will
          return shortly, elevated and renewed.
        </p>
