...
import { buildNotifyMessage, openWhatsApp } from "../lib/whatsapp";
    ...
    <div
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLDivElement).style.borderColor =
          "oklch(0.78 0.12 75 / 0.5)";
      }}
      onMouseLeave={(e) => {
        (e.currentTarget as HTMLDivElement).style.borderColor =
          "oklch(0.78 0.12 75 / 0.25)";
      }}
    >
      {/* Image */}
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            (e.currentTarget as HTMLButtonElement).style.background =
              "oklch(0.78 0.12 75 / 0.08)";
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLButtonElement).style.color =
              "oklch(0.78 0.12 75 / 0.8)";
            (e.currentTarget as HTMLButtonElement).style.borderColor =
              "oklch(0.78 0.12 75 / 0.4)";
            (e.currentTarget as HTMLButtonElement).style.background =
              "transparent";
          }}
        >
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            The next chapter of Luminia — new ventures on the horizon,
